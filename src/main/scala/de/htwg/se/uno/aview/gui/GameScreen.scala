...
import de.htwg.se.uno.model.{ActionCard, Card, CardFactory, GameState, NumberCard, PlayerHand}
...
//  (0 until players).foreach { index =>
//    val view = createHandViewForPlayer(index)
//    children += view
//  }

//  private val rotationMap: Map[Int, Double] = Map(
//    0 -> 0.0,
//    1 -> 0.0,
//    2 -> -90.0,
//    3 -> 90.0,
